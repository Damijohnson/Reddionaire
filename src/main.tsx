      ...
      <vstack gap="large" width="100%" height="100%" alignment="center" padding="large">
        <vstack gap="small" alignment="center">
          {timedOut ? (
           ...
           <image 
             ...
             <hstack backgroundColor={page.titleBar.pageTitle.background}cornerRadius={page.titleBar.pageTitle.cornerRadius} padding={page.titleBar.pageTitle.padding}>
               <text size={page.titleBar.pageTitle.textSize} weight={page.titleBar.pageTitle.textWeight} color={page.titleBar.pageTitle.textColor}>Times Up</text>
             </hstack>
           </hstack>
          ) : (
            <hstack alignment="start middle" gap="small">
          ...
          <image 
            ...
            <hstack backgroundColor={page.titleBar.pageTitle.background}cornerRadius={page.titleBar.pageTitle.cornerRadius} padding={page.titleBar.pageTitle.padding}>
              <text size={page.titleBar.pageTitle.textSize} weight={page.titleBar.pageTitle.textWeight} color={page.titleBar.pageTitle.textColor}>Game Over</text>
            </hstack>
          </hstack>
          )}
            <text size={page.subheading.textSize} weight={page.subheading.textWeight} color={page.subheading.textColor} alignment={page.subheading.alignment}>
          ...
          <vstack gap="medium" alignment="center">
            ...
            <image 
              ...
              />
                ...
                <hstack backgroundColor={page.titleBar.pageTitle.background}cornerRadius={page.titleBar.pageTitle.cornerRadius} padding={page.titleBar.pageTitle.padding}>
                <text size={page.titleBar.pageTitle.textSize} weight={page.titleBar.pageTitle.textWeight} color={page.titleBar.pageTitle.textColor}>Milestone Reached</text>
              </hstack>
            </hstack>
          <vstack gap="small" alignment="center">
          <text size={page.subheading.textSize} weight={page.subheading.textWeight} color={page.subheading.textColor} alignment={page.subheading.alignment}>
